...
export default function About() {
  return (
    <div id='about'  className='snap-y snap-center max-w-screen-xl mx-auto h-[100%] flex flex-col duration-[.9s]  gap-[2rem] px-[2.5rem] md:px-[0] md:gap-[50px] py-[10rem]'>
      ...
      <div className='flex flex-col-reverse md:flex-row-reverse items-center gap-[50px]'>
        <div className='relative flex-1 flex flex-col gap-[1rem]'>
          <hr className='w-[25px] absolute top-3 md:left-[-30px] left-[-10px] border-[1px] border-solid border-[whitesmoke]' />
